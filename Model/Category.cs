...
namespace Es.Udc.DotNet.PracticaMaD.Model
{
    ...
    public partial class Category
    {
        ...
        /// <summary>
        /// Relationship Name (Foreign Key in ER-Model): FK_Category_Category
        /// </summary>
    	...
    	public override int GetHashCode()
    	{
    	    unchecked
    	    {
    			...
    			hash = hash * multiplier + (fatherId == null ? 0 : fatherId.GetHashCode());
    	...
    	public override String ToString()
    	{
           ...
           strCategory.Append(" fatherId = " + fatherId + " | " );       
            strCategory.Append("] ");    
